...
class GnuCash_Data_Analysis:
    ...
    def get_trend_data(self, func: Callable, years_to_go_back: int, index_col: str, trend_col:str) -> pd.DataFrame:
    ...
    def get_df_with_trend_data(self, func: Callable, years_to_go_back: int, index_col: str, trend_col:str) -> pd.DataFrame:
        ...
        """
        trend = self.trendsetter(self.get_trend_data(func, years_to_go_back, index_col, trend_col))
